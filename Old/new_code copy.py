...
move_limit_sec                = 1.0       # Maximum allowed shift (seconds) searched in compute_lag
...
events = [event]        # relic for multiple events
...
for idx, channel in enumerate(channels):
    ...
    for eve_id in events:
        ...
        # ---- Estimated vs calculated shifts (per station) ----
        calc_shifts = {}
        if t_ref is not None:
            ...
            for tr in st_comp:
                ...
                # Theoretical travel time for this station and phase
