...
def handle_event_output_mode(
    ...
    """Dispatch per-event outputs for three-component vs single-component modes."""
    ...
    handle_single_component_outputs(
        ...
        aligned_traces_by_station=aligned_traces_by_station,
        name2ll=name2ll,
        plot_wall_start=plot_wall_start,
        plot_cpu_start=plot_cpu_start,
    )
